...
#            temp_cis_n_roots = 1
#        else:
#            temp_cis_n_roots = int(temp_cis_n_roots[0][0])  
...
#        self.data["cis_singlet"] = int(temp_cis_singlet[0][0])
        self.data["cis_singlet"] = temp_cis_singlet[0][0]
...
#       temp_adc2_pcm0 = read_pattern(self.text, {"key": r"\sADC\(2\)\/ptSS-PCM\(PTE\):\s*([\d\-\.]+)\seV"}).get("key")
#       self.data["adc2_pcm0"] = temp_adc2_pcm0[0][0]
